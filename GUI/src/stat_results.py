...
results_path = os.path.join('C:/Users/daisy/OneDrive/Documents/Group_project/BPT_Cranfield/GUI/results/test/test/results.txt')
...
output_path = os.path.join(cwd, 'results', project_name, 'test/Pollinator')
